...
public class UploadFotoTokoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_foto_toko);
            ...
            switch (requestCode) {
                case GALLERY_INTENT:
                    if (requestCode == GALLERY_INTENT && resultCode == RESULT_OK) {
                        ...
                        StorageReference tempatfile = mStoreRef.child("FotoToko").child(uri.getLastPathSegment());
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.button1:
                break;
            case R.id.button2:
                startActivity(new Intent(UploadFotoTokoActivity.this, KirimFotoActivity.class));
                break;
        }
    }
}
